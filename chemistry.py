# chemistry.py
# Enhancement: Program also prints the total number of atoms in the compound.
...
def main():
    ...
    # Enhancement: count total atoms
    total_atoms = sum(qty for _, qty in symbol_quantity_list)

    print(f"Molar mass of {formula}: {molar_mass:.5f} g/mol")
    print(f"Number of moles in {sample_mass} g: {moles:.5f} mol")
    print(f"Total atoms in {formula}: {total_atoms}")
